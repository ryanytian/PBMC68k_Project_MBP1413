...
RES_DIR <-  "/Users/ryanyutian/Desktop/PBMC68k_project/results/main_process_68k_from_download"      # SPECIFY HERE
...
pure_11 <- readRDS(file.path(DATA_DIR,'all_pure_select_11types_download.rds'))
...
# 1. Normalized (by umi counts) gene expression matrix
#       l$m

library('Matrix')
writeMM(obj = l$m, file="/Users/ryanyutian/Desktop/PBMC68k_project/input_data_68k_non_selective/normalized_expression.mtx")

# 2. Coordinates of genes used in the normalized gene expression matrix 
#       l$use_genes

write.csv(x=l$use_genes, file="/Users/ryanyutian/Desktop/PBMC68k_project/input_data_68k/used_genes.csv", row.names = FALSE)

# 3. Ensembl gene IDs and gene symbols that matches with the above gene 
#    coordinates:
#       all_data[[1]]$hg19$genes
#       all_data[[1]]$hg19$gene_symbols

write.csv(x=all_data[[1]]$hg19$genes, file="/Users/ryanyutian/Desktop/PBMC68k_project/input_data_68k/ensembl_genes.csv")
write.csv(x=all_data[[1]]$hg19$gene_symbols, file="/Users/ryanyutian/Desktop/PBMC68k_project/input_data_68k/gene_symbols.csv")

# 4. Table w/ information on the most variable genes 
#    (top 1000 genes are marked TRUE in the 'used' column)
#       df

write.csv(x=df, file="/Users/ryanyutian/Desktop/PBMC68k_project/input_data_68k/gene_variation_info.csv")

# 5. Cell type labels generated and tSNE coordinates for plotting
#       tdf_n_1000

write.csv(x=tdf_n_1000, file="/Users/ryanyutian/Desktop/PBMC68k_project/input_data_68k/tsne_coord_and_cell_labels.csv")
